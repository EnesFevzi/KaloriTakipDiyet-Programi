...
namespace KaloriTakipProgramı.Data.Migrations
{
    ...
    [Migration("20230920112734_vcxvcxx")]
    partial class vcxvcxx
    {
            ...
            modelBuilder.Entity("KaloriTakipProgramı.Entity.Entities.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2023, 9, 20, 14, 27, 34, 588, DateTimeKind.Local).AddTicks(385),
                            Status = false
                        });
                });
            ...
            modelBuilder.Entity("KaloriTakipProgramı.Entity.Entities.ConsumeFood", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2023, 9, 20, 14, 27, 34, 588, DateTimeKind.Local).AddTicks(427),
                            Fat = 0.2f,
                        ...
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2023, 9, 20, 14, 27, 34, 588, DateTimeKind.Local).AddTicks(430),
                            Fat = 3.6f,
                            GramCompensation = 100f,
                            MealID = 1,
                            Protein = 31f,
                        ...
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2023, 9, 20, 14, 27, 34, 588, DateTimeKind.Local).AddTicks(431),
                            Fat = 0.3f,
                            GramCompensation = 100f,
                            MealID = 1,
                            Protein = 2.7f,
                        ...
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2023, 9, 20, 14, 27, 34, 588, DateTimeKind.Local).AddTicks(432),
                            Fat = 13f,
                            GramCompensation = 100f,
                            MealID = 1,
                            Protein = 22f,
                        ...
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2023, 9, 20, 14, 27, 34, 588, DateTimeKind.Local).AddTicks(434),
                            Fat = 1.5f,
                            GramCompensation = 100f,
                            MealID = 1,
                            Protein = 5f,
            ...
            modelBuilder.Entity("KaloriTakipProgramı.Entity.Entities.Food", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Carbohydrate = 0f,
                            CategoryID = 1,
                            CreatedDate = new DateTime(2023, 9, 20, 14, 27, 34, 588, DateTimeKind.Local).AddTicks(401),
                            Fat = 0.13f,
                            FoodName = "Somon",
                            GramCompensation = 100f,
                            Protein = 0.19f,
                        ...
                        new
                        {
                            ...
                            Carbohydrate = 0.01f,
                            CategoryID = 1,
                            CreatedDate = new DateTime(2023, 9, 20, 14, 27, 34, 588, DateTimeKind.Local).AddTicks(404),
                            Fat = 0.08f,
                            FoodName = "Ahtapot",
                            GramCompensation = 100f,
                            Protein = 0.15f,
                        ...
                        new
                        {
                            ...
                            Carbohydrate = 0f,
                            CategoryID = 1,
                            CreatedDate = new DateTime(2023, 9, 20, 14, 27, 34, 588, DateTimeKind.Local).AddTicks(406),
                            Fat = 0.02f,
                            FoodName = "Alabalık",
                            GramCompensation = 100f,
                            Protein = 0.19f,
                        ...
                        new
                        {
                            ...
                            Carbohydrate = 0f,
                            CategoryID = 1,
                            CreatedDate = new DateTime(2023, 9, 20, 14, 27, 34, 588, DateTimeKind.Local).AddTicks(407),
                            Fat = 0.06f,
                            FoodName = "Barbun",
                            GramCompensation = 100f,
                            Protein = 0.16f,
                        ...
                        new
                        {
                            ...
                            Carbohydrate = 0f,
                            CategoryID = 1,
                            CreatedDate = new DateTime(2023, 9, 20, 14, 27, 34, 588, DateTimeKind.Local).AddTicks(408),
                            Fat = 0.06f,
                            FoodName = "Çipura",
                            GramCompensation = 100f,
                            Protein = 0.16f,
                        ...
                        new
                        {
                            ...
                            Carbohydrate = 0f,
                            CategoryID = 1,
                            CreatedDate = new DateTime(2023, 9, 20, 14, 27, 34, 588, DateTimeKind.Local).AddTicks(409),
                            Fat = 0f,
                            FoodName = "Dil Balığı",
                            GramCompensation = 100f,
                            Protein = 0.19f,
                        ...
                        new
                        {
                            ...
                            Carbohydrate = 0.05f,
                            CategoryID = 1,
                            CreatedDate = new DateTime(2023, 9, 20, 14, 27, 34, 588, DateTimeKind.Local).AddTicks(410),
                            Fat = 0.1f,
                        ...
                        new
                        {
                            ...
                            Carbohydrate = 0f,
                            CategoryID = 1,
                            CreatedDate = new DateTime(2023, 9, 20, 14, 27, 34, 588, DateTimeKind.Local).AddTicks(411),
                            Fat = 0.05f,
                        ...
                        new
                        {
                            ...
                            Carbohydrate = 0.03f,
                            CategoryID = 1,
                            CreatedDate = new DateTime(2023, 9, 20, 14, 27, 34, 588, DateTimeKind.Local).AddTicks(412),
                            Fat = 0.15f,
                            FoodName = "Havyar",
                            GramCompensation = 100f,
                            Protein = 0.26f,
                        ...
                        new
                        {
                            ...
                            Carbohydrate = 0f,
                            CategoryID = 1,
                            CreatedDate = new DateTime(2023, 9, 20, 14, 27, 34, 588, DateTimeKind.Local).AddTicks(413),
                            Fat = 0.02f,
                            FoodName = "Istakoz",
                            GramCompensation = 100f,
                            Protein = 0.17f,
