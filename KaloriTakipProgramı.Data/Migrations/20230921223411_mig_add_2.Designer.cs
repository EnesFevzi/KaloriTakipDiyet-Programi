...
namespace KaloriTakipProgramı.Data.Migrations
{
    ...
    [Migration("20230921223411_mig_add_2")]
            ...
            modelBuilder.Entity("KaloriTakipProgramı.Entity.Entities.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2023, 9, 22, 1, 34, 10, 937, DateTimeKind.Local).AddTicks(3997),
                            Status = false,
                            Value = 1
                        },
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2023, 9, 22, 1, 34, 10, 937, DateTimeKind.Local).AddTicks(4011),
                            Status = false,
                            Value = 1
                        });
                });
            ...
            modelBuilder.Entity("KaloriTakipProgramı.Entity.Entities.Food", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Carbohydrate = 0f,
                            CategoryID = 1,
                            CreatedDate = new DateTime(2023, 9, 22, 1, 34, 10, 937, DateTimeKind.Local).AddTicks(4020),
                            Fat = 0.13f,
                            FoodName = "Somon",
                        ...
                        new
                        {
                            ...
                            Carbohydrate = 0.01f,
                            CategoryID = 1,
                            CreatedDate = new DateTime(2023, 9, 22, 1, 34, 10, 937, DateTimeKind.Local).AddTicks(4022),
                            Fat = 0.08f,
                            FoodName = "Ahtapot",
                            GramCompensation = 100f,
                            Protein = 0.15f,
                        ...
                        new
                        {
                            ...
                            Carbohydrate = 0f,
                            CategoryID = 1,
                            CreatedDate = new DateTime(2023, 9, 22, 1, 34, 10, 937, DateTimeKind.Local).AddTicks(4024),
                            Fat = 0.02f,
                            FoodName = "Alabalık",
                            GramCompensation = 100f,
                            Protein = 0.19f,
                        ...
                        new
                        {
                            ...
                            Carbohydrate = 0f,
                            CategoryID = 1,
                            CreatedDate = new DateTime(2023, 9, 22, 1, 34, 10, 937, DateTimeKind.Local).AddTicks(4025),
                            Fat = 0.06f,
                            FoodName = "Barbun",
                            GramCompensation = 100f,
                            Protein = 0.16f,
                        ...
                        new
                        {
                            ...
                            Carbohydrate = 0f,
                            CategoryID = 1,
                            CreatedDate = new DateTime(2023, 9, 22, 1, 34, 10, 937, DateTimeKind.Local).AddTicks(4026),
                            Fat = 0.06f,
                            FoodName = "Çipura",
                            GramCompensation = 100f,
                            Protein = 0.16f,
                        ...
                        new
                        {
                            ...
                            Carbohydrate = 0f,
                            CategoryID = 1,
                            CreatedDate = new DateTime(2023, 9, 22, 1, 34, 10, 937, DateTimeKind.Local).AddTicks(4027),
                            Fat = 0f,
                            FoodName = "Dil Balığı",
                            GramCompensation = 100f,
                            Protein = 0.19f,
                        ...
                        new
                        {
                            ...
                            Carbohydrate = 0.05f,
                            CategoryID = 1,
                            CreatedDate = new DateTime(2023, 9, 22, 1, 34, 10, 937, DateTimeKind.Local).AddTicks(4028),
                            Fat = 0.1f,
                        ...
                        new
                        {
                            ...
                            Carbohydrate = 0f,
                            CategoryID = 1,
                            CreatedDate = new DateTime(2023, 9, 22, 1, 34, 10, 937, DateTimeKind.Local).AddTicks(4029),
                            Fat = 0.05f,
                        ...
                        new
                        {
                            ...
                            Carbohydrate = 0.03f,
                            CategoryID = 1,
                            CreatedDate = new DateTime(2023, 9, 22, 1, 34, 10, 937, DateTimeKind.Local).AddTicks(4030),
                            Fat = 0.15f,
                            FoodName = "Havyar",
                            GramCompensation = 100f,
                            Protein = 0.26f,
                        ...
                        new
                        {
                            ...
                            Carbohydrate = 0f,
                            CategoryID = 1,
                            CreatedDate = new DateTime(2023, 9, 22, 1, 34, 10, 937, DateTimeKind.Local).AddTicks(4031),
                            Fat = 0.02f,
                            FoodName = "Istakoz",
                            GramCompensation = 100f,
                            Protein = 0.17f,
            ...
            modelBuilder.Entity("KaloriTakipProgramı.Entity.Entities.Meal", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            MealID = 1,
                            CreatedDate = new DateTime(2023, 9, 22, 1, 34, 10, 937, DateTimeKind.Local).AddTicks(4043),
                            MealName = "Sabah",
                            Status = false,
                            Value = 1
                        },
                        ...
                        {
                            MealID = 2,
                            CreatedDate = new DateTime(2023, 9, 22, 1, 34, 10, 937, DateTimeKind.Local).AddTicks(4051),
                            MealName = "Öğle",
                            Status = false,
                            Value = 1
                        },
                        ...
                        {
                            MealID = 3,
                            CreatedDate = new DateTime(2023, 9, 22, 1, 34, 10, 937, DateTimeKind.Local).AddTicks(4055),
                            MealName = "Akşam",
                            Status = false,
                            Value = 1
                        },
                        ...
                        {
                            MealID = 4,
                            CreatedDate = new DateTime(2023, 9, 22, 1, 34, 10, 937, DateTimeKind.Local).AddTicks(4060),
                            MealName = "Snack",
                            Status = false,
                            Value = 1
                        });
